...
VALUES
 ...
 -- Задание №1 "Операторы, фильтрация..."
...
select
dayname(concat_ws('.', date_format (birthday_at, '%d.%m'), year(now()))) as day_name,
count(*) as  total
from 
users
group by
...
VALUES
  ...
  -- Задание №2 "Операторы, фильтрация..."
...
VALUES
  ...
  -- Задание №3 "Операторы, фильтрация..."
